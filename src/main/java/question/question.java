...
public class question extends javax.swing.JFrame {
    ...
    private void tampilData(){
        ...
        try{
            Object[] judul_kolom = {"ID", "Pertanyaan", "Jawab"};
   ...
   private void seteditOn(){
    ...
    private void initComponents() {
        ...
        jLabelHeader.setText("Data Question");
        jLabelHeader.setOpaque(true);

        jPanel1.setBackground(new java.awt.Color(0, 0, 0));

        TabelProduk.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if (NamaProduk.isEmpty()) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("insert into questions(question,answer)"+
                    "VALUES('"+NamaProduk+"','"+Harga+"')");
                BersihData();
                tampilData();
                SetEditOff();
 ...
 if (question.isEmpty()) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("UPDATE questions SET question='"+question+"', answer='"+answer+"' WHERE id='"+id+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        try{
            Connection conn=(Connection)koneksi.koneksiDB();
            Statement stt=conn.createStatement();
            stt.executeUpdate("DELETE FROM questions WHERE id='"+KodeProduk+"'");
            BersihData();
            tampilData();
            SetEditOff();
