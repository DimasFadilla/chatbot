...
public class data extends javax.swing.JFrame {
    ...
    private void tampilData(){
        ...
        try{
            Object[] judul_kolom = {"ID", "User Name", "Date" };
            ...
            RsProduk=stt.executeQuery("SELECT * from user WHERE username LIKE'%"+cari+"%'");  
            while(RsProduk.next()){
                Object[] data={
   ...
   private void autonumber(){
        try{
            ...
            if (r.next()) {
                String NoID = r.getString("user_id").substring(2);
                ...
                jTextKodeProduk.setText("14" + Zero + ID);
            }else{
                jTextKodeProduk.setText("142971311");
            }
            r.close();
            s.close();
    ...
    private void initComponents() {
        ...
        TabelProduk.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jButtonAdd.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
        ...
        jButtonSave.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
        ...
        jButtonUpdate.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
        ...
        jButtonDelete.setBackground(new java.awt.Color(153, 0, 153));
        ...
        jButtonCancel.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
        ...
        cmdKeluar.setBackground(new java.awt.Color(153, 153, 0));
        cmdKeluar.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
        ...
        jBcari.setBackground(new java.awt.Color(255, 153, 153));
        jBcari.setFont(new java.awt.Font("Segoe UI Black", 3, 12)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jLabelNama, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jTextKodeProduk, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTcari, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jButtonCancel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cmdKeluar, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelHeader, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if (KodeProduk.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("insert into user(user_id,username,CreateDate)"+
                    "VALUES('"+KodeProduk+"','"+NamaProduk+"','"+CreateDate+"')");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
      ...
      String user_id=jTextKodeProduk.getText();
 ...
 if (user_id.isEmpty()) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("UPDATE user SET username='"+username+"',CreateDate='"+CreateDate+"' WHERE user_id='"+user_id+"'");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        try{
            Connection conn=(Connection)koneksi.koneksiDB();
            Statement stt=conn.createStatement();
            stt.executeUpdate("DELETE FROM user WHERE user_id='"+KodeProduk+"'");
            BersihData();
            tampilData();
            SetEditOff();
